...
JBuilder is a simple templating for generating JSON output. With Builder-like DSL it allows you to have your controllers and models clean of view logic.
...
After an easy start with Rails and JSON based API, I found myself struggling to implement it the right way in the MVC pattern.
