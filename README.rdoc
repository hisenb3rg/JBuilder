...
* if the directive is not one of those mentioned, there is a shorthand directive that tries to guess the directive from arguments
* shorthand directive takes the directive name as first argument, and value as the second argument
