...
Gem::Specification.new do |s|
  ...
  s.files = ["Manifest", "Rakefile", "lib/jbuilder.rb", "lib/jbuilder/jbuilder_dsl.rb", "lib/jbuilder/jbuilder_handler.rb", "lib/jbuilder/railtie.rb", "jbuilder.gemspec"]
  s.homepage = %q{http://github.com/antiveb/jbuilder}
  s.rdoc_options = ["--line-numbers", "--inline-source", "--title", "Jbuilder"]
  s.require_paths = ["lib"]
